...
class SimulatePlumage():
    ...
    def __init__(self,N=10000,s_a=-0.01,s_A=-0.001,p=0.8,S=0.0001,alpha=12.09,beta=0.39,x_T=38,dx_T=1,m=0.02/(2022-1944)):
        self.N = N
        self.s_A = s_A
        self.p = p
        self.S = S
    ...
    def getDaysLin(self)
        ...
        self.d_A = 365*self.TotalDgTmaxLin(self.x_T,self.m)
