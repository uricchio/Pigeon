...
read.table("~/projects/Pigeon/simData/sim.dx_T.0.5.d.0.05.txt")->popSims
...
plB<-plB+scale_color_manual(values=wes_palette("Zissou1",6,type="continuous"),name=expression(italic(X[T])))
